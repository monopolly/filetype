...
import (
	...
	"github.com/monopolly/filetype/internal/matchers"
)
...
func Video(file string) (res bool) {
	f, err := os.Open(file)
	if err != nil {
		return
	}
...
func Audio(file string) (res bool) {
	f, err := os.Open(file)
	if err != nil {
		return
	}
...
func Image(file string) (res bool) {
	f, err := os.Open(file)
	if err != nil {
		return
	}
